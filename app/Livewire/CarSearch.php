...
// Trait che abilita la paginazione nei componenti Livewire.

class CarSearch extends Component
// Componente Livewire che gestisce la ricerca avanzata delle auto.
{
    use WithPagination;
    // Abilita la paginazione automatica.

    public $search = '';
    // Testo di ricerca (titolo o descrizione).
    ...
    public $km_max = '';
    // Filtro per chilometraggio massimo.

    public $order = '';
    // Ordinamento (price_asc, price_desc).
    ...
    // Metodo principale: costruisce la query filtrata e restituisce la vista.
    {
        $cars = Car::with('images', 'category', 'user')
            ...
            ->latest()
            // Ordina per data di creazione (fallback).

{{-- 
Componente Blade: Link laterale (sidebar link) con stato attivo/inattivo

Props:
- active: boolean che indica se il link rappresenta la pagina corrente

Funzionalità:
- Evidenziazione del link attivo con bordo sinistro colorato e background dedicato
- Stile hover e focus per i link inattivi

{{-- 
Sezione: Informazioni profilo utente (Automarket)

Funzionalità:
- Permette all’utente di aggiornare nome ed email
- Gestisce la verifica email (invio nuovo link se non verificata)
...
<section>
    ...
    {{-- Form per reinviare email di verifica --}}
